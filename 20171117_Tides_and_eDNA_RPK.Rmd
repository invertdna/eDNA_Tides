...
As environmental DNA (eDNA) becomes an increasingly important tool in ecological research (~\cite{sigsgaard2016population,deiner2017environmental} ), it is critical to understand how techniques for eDNA collection and analysis perform under real-world conditions (~\cite {MEC:MEC13481}). In particular, we must characterize the spatial and temporal resolution of amplicon-sequencing studies in order to confidently detect ecological patterns in the field (~\cite{o2017spatial}). 
